...
const int testType = c_testThreeOsc2;    // set this to select the test to run
...
void testThreeOsc2(double,double,double);
...
int main(void) {
    switch (testType) {
        ...
        case c_testThreeOsc2:
            testThreeOsc2(55.0,55.5,56);
            break;
        case c_testSawSweep:
            testSawSweep();
            break;
...
void testThreeOsc2(double f1, double f2, double f3) {
    // make an oscillator with Wavetable
    WavetableOsc *osc1 = new WavetableOsc();
    WavetableOsc *osc2 = new WavetableOsc();
    WavetableOsc *osc3 = new WavetableOsc();
    ...
    osc3->setFrequency(f3/sampleRate);
